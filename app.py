...
def welcome():
   ...
   <a href="/api/v1.0/stations">/api/v1.0/stations</a>
    ...
    <br>Replace &ltstart&gt with a date in Year-Month-Day(like: 2017-01-07) format.
    <br>
    <a href="/api/v1.0/2017-01-01">/api/v1.0/start</a>
    </li>
    <br>
    <li>
    JSON list of tmin, tmax, tavg for the dates in range of start date and end date inclusive:
    <br>
    Replace &ltstart&gt and &ltend&gt with a date in Year-Month-Day(like: 2017-01-07) format. 
    <br>
    <a href="/api/v1.0/2017-01-01/2017-01-07">/api/v1.0/start/end</a>
    </li>
    <br>
    </ul>
    </html>
...
def precipitation():
    # Docstring 
    """Dictionary list of precipitations from last year"""
